export function DeleteWindow({ isOpen, onClose, asignacion, onSave })
{
    const handleSubmit = async (e) => {

        await onSave("DELETE", null, null, asignacion.comida_id);
        ...
        <div className="fixed z-20 inset-0 flex items-center justify-center bg-black/50">
            <div className="bg-white p-4 rounded-lg shadow-lg">
                <div className="form-header max-w-64 mb-6">
                    <h2 className="font-bold font-inter text-2xl w-full">Eliminar Comida</h2>
                    <h3 className="text-neutral-500 text-lg">{asignacion.nombre_comida}</h3>
                </div>
                <p>¿Estás seguro de querer eliminar esta comida?</p>
