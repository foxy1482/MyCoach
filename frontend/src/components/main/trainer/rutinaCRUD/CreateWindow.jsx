...
export function CreateWindowR({ isOpen, onClose, onSave })
{
    ...
    <div className="fixed z-20 inset-0 flex items-center justify-center bg-black/50">
        <div className="bg-white p-4 rounded-lg shadow-lg">
            <div className="form-header max-w-64 mb-6">
                <h2 className="font-bold font-inter text-2xl w-full">Crear Rutina</h2>
            </div>
            ...
            <div className="input flex flex-row">
                ...
                <input
                    ...
                    onChange={(e) => {
                            ...
                            setNewValue(prev => ({ ...prev, es_personalizada : personalizada ? true : false}))
                        }
                    }
