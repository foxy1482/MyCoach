export function DeleteWindowR({ isOpen, onClose, rutina, onSave })
{
        ...
        <div className="fixed z-20 inset-0 flex items-center justify-center bg-black/50">
            <div className="bg-white p-4 rounded-lg shadow-lg">
                <div className="form-header max-w-64 mb-6">
                    <h2 className="font-bold font-inter text-2xl w-full">Eliminar Asignación</h2>
                    <h3 className="text-neutral-500 text-lg">{rutina.nombre}</h3>
                </div>
                <p>¿Estás seguro de querer eliminar esta rutina? No hay vuelta atrás.</p>
