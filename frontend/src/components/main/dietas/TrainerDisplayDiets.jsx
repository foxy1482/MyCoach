...
import { ModalAlumnoDietas } from "./ModalAlumnoDietas.jsx";


export function TrainerDisplayDiets()
{
        ...
        <section className="trainer-section w-6/12 m-auto">
            ...
            <div className="trainer-trainees flex flex-col">
                ...
                (
                    ...
                    <ModalAlumnoDietas token={token} alumnoActivo={alumnoActivo} setAlumnoActivo={setAlumnoActivo}></ModalAlumnoDietas>
                ) : (
